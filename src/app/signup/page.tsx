            ...
            <div>
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-2">
                {stats.map((s) => (
                  ...
                  >
                    <span className="min-w-[64px] text-base font-bold text-navy-700">{s.label}</span>
              ...
              <div className="rounded-card border border-ink-200 bg-white p-8 shadow-soft">
                ...
                <div className="mt-6 border-t border-ink-200 pt-5">
                  <p className="text-xs text-ink-500">
                    Or sign in with{" "}
                    <Link href="/builders/login" className="font-medium text-navy-700 underline-offset-4 hover:underline">
                      email magic link
                    </Link>
                    .
                  </p>

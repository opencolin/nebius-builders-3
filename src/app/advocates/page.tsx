        ...
        <section className="section bg-ink-50">
          <div className="container-page">
                  ...
                  <div className="flex h-full flex-col gap-4 rounded-card border border-ink-200 bg-white p-6 transition-colors hover:border-ink-300 hover:shadow-soft">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="text-base font-semibold text-ink-900 group-hover:text-navy-700">
                          {adv.name}
                        </h3>
                        <p className="mt-1 text-xs font-semibold uppercase tracking-widest text-ink-500">
                          {adv.title.replace(", Nebius", "")}
                        </p>
                        <p className="mt-1 text-sm text-ink-600">{adv.region}</p>
                      </div>
                    </div>
                    <p className="text-sm text-ink-600 line-clamp-3">{adv.bio}</p>
                    ...
                    {adv.calendlyUrl ? (
                      <p className="mt-auto pt-3 text-sm font-semibold text-navy-700 group-hover:underline">
                        Book office hours →
                      </p>
                    ) : null}
                  </div>
            ...
            <div className="mt-12 rounded-card border border-ink-200 bg-white p-8">
              <h3 className="text-lg font-semibold text-ink-900">Don't see your region covered?</h3>
              <p className="mt-2 max-w-2xl text-ink-600">
                Reach out to Colin (Lead DevRel) — he handles unrouted requests and can pull in a

        ...
        <div className="container-page">
          <div className="mb-6 flex items-end justify-between">
            <div>
              ...
              <p className="text-sm text-ink-500">Upload here. The post-event summary picks the best 12 automatically.</p>
            </div>
          ...
          <p className="mt-8 text-xs text-ink-500">Photos auto-flow into the post-event summary at <code className="kbd">/events/{events.find(e => e.slug === params.slug)?.slug}/recap</code> when the event ends.</p>
        </div>
      </section>
    </EventManagerShell>
  );

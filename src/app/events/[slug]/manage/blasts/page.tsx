      ...
      <section className="section">
        <div className="container-page grid gap-8 lg:grid-cols-3">
          <div className="card lg:col-span-2">
            ...
            <p className="text-sm text-ink-500 dark:text-ink-400">Lands on every builder's dashboard for this event. No email — keep it short and action-oriented.</p>
            <div className="mt-5 grid gap-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-ink-500 dark:text-ink-400">Audience: 187 builders registered for this event</span>
          ...
          <div className="card">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-ink-500 dark:text-ink-400">Templates</h3>
            ...
            <ul className="mt-3 divide-y divide-ink-200">
              {eventBlasts.map((b) => (
                <li key={b.id} className="grid gap-2 py-3 md:grid-cols-12">
                  <p className="md:col-span-2 text-xs uppercase tracking-widest text-ink-500 dark:text-ink-400">{formatTime(b.sentAt)}</p>

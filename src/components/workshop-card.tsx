    ...
    >
      <div className={`relative aspect-video bg-gradient-to-br from-navy-700 via-navy-600 to-lime ${featured ? "md:aspect-auto md:w-1/2" : ""}`}>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="rounded-full bg-white dark:bg-ink-900/95 px-5 py-3 text-sm font-semibold text-navy-700 dark:text-lime">▶ Watch · {formatDuration(workshop.durationSeconds)}</div>
        </div>

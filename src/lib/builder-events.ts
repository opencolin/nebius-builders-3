...
export const builderEvents: BuilderEvent[] = [
  {
    id: "e_1",
    title: "Fine-Tune Gemma 4 on Your Data — LoRA Hands-On",
    description:
      "Hands-on LoRA fine-tune of Gemma 4 on your own data. Bring a laptop and a dataset; leave with a working adapter deployed on Nebius.",
    format: "WORKSHOP",
    startsAt: "2026-05-06T02:00:00Z",
    endsAt: "2026-05-06T04:00:00Z",
    timezone: "America/Los_Angeles",
    venueName: "Frontier Tower — Lounge on 16th",
    ...
    status: "PUBLISHED",
    lumaUrl: "https://luma.com/fine-tune-gemma-4-on-your-data-lora-hand?tk=mw2JKC",
  },
  {
    id: "e_2",

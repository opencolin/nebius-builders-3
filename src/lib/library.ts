...
export const library: LibraryEntry[] = [
  ...
  {
    slug: "agent-inference-workshop",
    type: "WORKSHOP",
    title: "Agent Inference Workshop",
    blurb:
      "Use Nebius Token Factory for agent inference. Open-source model selection, prompt patterns, latency tuning.",
    level: "BEGINNER",
    durationMin: 45,
    productFocus: ["tokenfactory"],
    externalUrl: "https://claw.camp/curriculum/agent-inference",
    isOfficial: true,
  },
  {
    slug: "agent-lifecycle-workshop",
    type: "WORKSHOP",
    title: "Agent Lifecycle Workshop",
    blurb: "Develop, deploy, and monitor an AI agent on Nebius end-to-end.",
    level: "INTERMEDIATE",
    durationMin: 60,
    productFocus: ["openclaw", "aicloud"],
    externalUrl: "https://claw.camp/curriculum/agent-lifecycle",
    isOfficial: true,
  },
  {
    slug: "three-deployment-patterns",
    type: "WORKSHOP",
    title: "Three Deployment Patterns",
    blurb:
      "Side-by-side: npm install (5 min) vs. Docker (10 min) vs. Nebius Serverless (20 min). When to pick which.",
    level: "INTERMEDIATE",
    durationMin: 45,
    productFocus: ["aicloud", "openclaw"],
    externalUrl: "https://claw.camp/curriculum/deploy-architecture",
    isOfficial: true,
  },
  {
    slug: "deploy-via-nebius-console",
    type: "WORKSHOP",
    title: "Deploy via Nebius Web Console",
    blurb: "UI-only walkthrough — lowest-friction first deploy on Nebius. No CLI required.",
    level: "BEGINNER",
    durationMin: 20,
    productFocus: ["aicloud"],
    externalUrl: "https://claw.camp/curriculum/deploy-console",
    isOfficial: true,
  },
  {
    slug: "deployment-patterns-troubleshooting",
    type: "WORKSHOP",
    title: "Deployment Patterns & Troubleshooting",
    blurb: "Common failure modes when deploying to Nebius and how to recover.",
    level: "INTERMEDIATE",
    durationMin: 40,
    productFocus: ["aicloud"],
    externalUrl: "https://claw.camp/curriculum/deploy-patterns",
    isOfficial: true,
  },
  {
    slug: "deploy-with-install-scripts",
    type: "WORKSHOP",
    title: "Deploy with Install Scripts",
    blurb: "Copy-paste shell scripts to deploy OpenClaw on Nebius.",
    level: "BEGINNER",
    durationMin: 25,
    productFocus: ["openclaw", "aicloud"],
    externalUrl: "https://claw.camp/curriculum/deploy-scripts",
    isOfficial: true,
  },
  {
    slug: "install-openclaw-tokenfactory-locally",
    type: "WORKSHOP",
    title: "Install OpenClaw + Token Factory Locally",
    blurb:
      "Get OpenClaw running on your laptop with Nebius Token Factory wired up as the inference provider.",
    level: "BEGINNER",
    durationMin: 15,
    productFocus: ["openclaw", "tokenfactory"],
    externalUrl: "https://claw.camp/curriculum/local-install",
    isOfficial: true,
  },
  {
    slug: "private-agents-workshop",
    type: "WORKSHOP",
    title: "Private Agents Workshop",
    blurb: "Run private/internal agents on dedicated Nebius infra.",
    level: "ADVANCED",
    durationMin: 75,
    productFocus: ["aicloud", "soperator"],
    externalUrl: "https://claw.camp/curriculum/private-agents",
    isOfficial: true,
  },
  {
    slug: "nebius-inference-overview",
    type: "WORKSHOP",
    title: "Nebius Inference (Overview)",
    blurb: "Hub page connecting the Nebius inference family of workshops.",
    level: "BEGINNER",
    durationMin: 10,
    productFocus: ["tokenfactory", "aicloud"],
    externalUrl: "https://claw.camp/curriculum/nebius-inference",
    isOfficial: true,
  },
  {
